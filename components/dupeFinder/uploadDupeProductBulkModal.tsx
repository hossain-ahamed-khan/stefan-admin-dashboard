...
import { useUploadDupeProductBulkFile } from "@/apis/hooks/useExpensiveProducts";


export default function UploadDupeProductBulkModal({onClose,}: {onClose: () => void;}) {
    const [file, setFile] = useState<File | null>(null);

    const { mutate: uploadFile, isPending } =
        useUploadDupeProductBulkFile();
        ...
        uploadFile(file, {
            onSuccess: (response) => {
                Swal.fire({
                    ...
                    text:
                        response?.message ||
                        "Dupe products uploaded successfully.",
                });
